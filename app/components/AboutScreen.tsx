...
export default function AboutScreen({ navigation }: AboutScreenProps) {
  const aboutDescription =
    "SIGNCOM is a real-time vision-based application that enables seamless video communication between individuals who use sign language and those who communicate through spoken language, by leveraging advanced hand sign recognition and translation technologies in real-time. This will enable everyone to interact with each other over the internet and to converse with each other through video calling, regardless of their disabilities.";
